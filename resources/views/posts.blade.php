  ...
  <form action="/blog">
    <div class="col-span-full">
      <div class="mt-2 flex gap-2">
        <input type="text" name="search" id="search" autocomplete="search" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" placeholder="Search..." >
  ...
  @if ($posts->count())
    <div class="bayang rounded mt-5">
      ...
      <div class="p-4 text-center"> 
        ...
        <p>By: <a href="/author/{{ $posts[0]->user->username }}" class="font-semibold relative text-gray-900 hover:text-gray-600 
          after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] 
          after:bg-gray-600 after:transition-all after:duration-300 hover:after:w-full">{{ $posts[0]->user->name }}</a> in <a href="/category/{{ $posts[0]->category->slug }}" class="relative text-gray-900 hover:text-gray-600 
          after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] 
    ...
    @foreach ($posts->skip(1) as $post)
      <div class="bayang rounded">
        ...
        <div class="p-4 text-center"> 
          ...
          <p>By: <a href="/author/{{ $post->user->username }}" class="font-semibold relative text-gray-900 hover:text-gray-600 
            after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] 
